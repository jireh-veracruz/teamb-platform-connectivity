...
#define COMMON_MSG_HI                      0
#define COMMON_MSG_HELLO                   1
#define COMMON_MSG_BROADCAST               2
#define COMMON_MSG_ID_DESTI                3
#define COMMON_MSG_RAND_HOLD               4
#define COMMON_MSG_READ                    5
#define COMMON_MSG_WRITE                   6
#define COMMON_MSG_CMD                     7
